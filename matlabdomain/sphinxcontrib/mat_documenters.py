...
mat_ext_sig_re_python_style = re.compile(
...
# matlab type with return type before
        ...
        *self.args* and *self.retann* if parsing and resolving was successful.
        ...
        try:
            explicit_modname, path, base, args, retann = \
                 mat_ext_sig_re_python_style.match(self.name).groups()
...
class MatDocstringSignatureMixin(object):
    ...
    def _find_signature(self, encoding=None):
        ...
        if not match:
            return
        retann, exmod, path, base, args = match.groups()
