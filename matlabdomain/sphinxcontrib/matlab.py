...
def setup(app):
    ...
    app.add_config_value('matlab_doc_getset', False, 'env')
    ...
    app.add_autodocumenter(doc.MatClassMemberGroupDocumenter)
    ...
    app.add_autodoc_attrgetter(doc.MatClassMemberGroup, doc.MatClassMemberGroup.getter)
